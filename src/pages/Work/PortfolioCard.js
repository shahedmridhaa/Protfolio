...
const PortfolioCard = ({ projectList }) => {
  ...
  return (
    <div>
      {/* <div
        className="flex flex-col group shadow-md
          border border-gray-800 rounded-xl overflow-hidden shadow-[#141a2a] transition bg-[#070b14] "
      >
        <div className="relative pt-[70%] rounded-t-xl overflow-hidden">
          <img
            className="w-full absolute top-0 left-0 object-cover group-hover:scale-105 transition-transform duration-500 ease-in-out rounded-t-xl"
            src={image}
            alt="img"
          />
        </div>
